...
public class EnemyAI : MonoBehaviour
{
    ...
    //which direction do we want to patrol in?
    ...
    void Update()
    {
        ...
        } //do we want to partol?
        else if (patrol)
        {
            //have enemy patrol in given direction
            //if they get too far away from start position, flip their direction
            Vector3 displacment = transform.position - home;
            if (displacment.magnitude > patrolDistance)
            {
                patrolDirection = -displacment;
            }
            //push enemy in direction of the patrol
